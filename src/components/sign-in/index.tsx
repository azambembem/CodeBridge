...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen  bg-gradient-to-l from-[#4BC0C8] via-[#C779D0] to-[#FEAC5E] flex items-start justify-center pt-[152px] p-4">
      <div className="w-full max-w-[90vw] sm:max-w-md lg:max-w-lg bg-transparent sm: bg-gradient-to-l from-[#4BC0C8] via-[#C779D0] to-[#FEAC5E] rounded-none md:rounded-[12px] p-4 sm:p-6 lg:p-12">
        ...
        >
          <div>
            ...
            <Input
              ...
              className=" border-[#eee] text-[#EEEEEE] placeholder-[#747474] h-[42px] text-[14px] font-light"
            />
          ...
          <div className="text-center mt-4 sm:mt-6 lg:mt-8">
            <div className="flex justify-center items-center space-x-4 text-[14px] font-light">
              <button
                ...
                type="button"
                className="text-[#EEEEEE] hover:text-[#333] transition-colors"
              >
                회원가입
              </button>
